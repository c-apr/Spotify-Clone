...
songItem.forEach((element, i) => {
    ...
    let audioElement2 = new Audio(songs[i].filePath);
    console.log(audioElement2);
    console.log(audioElement2.duration);
    // function enlarger(){
    //     console.log(element.getElementsByClassName("timestamp")[i]);
    // }
    // element.getElementsByClassName("timestamp")[i].innerText=audioElement2.duration;
...
masterPlay.addEventListener('click', () => {
    ...
    if (audioElement.paused || audioElement.currentTime <= 0) {
        ...
        // .getElementsById("playImg")[0].src = songs[i].coverPath;
        // gif.style.opacity = 1;
    }
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        ...
        playImg.src =  `covers/${songIndex+1}.jpg`;
